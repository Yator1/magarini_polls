...
@section('content')
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
{{--                    <img src="{{ URL::asset('/documents/logo/'.$company->company_logo) ?? URL::asset('build/images/users/avatar-1.jpg') }} " alt="user-img" class="img-thumbnail rounded-circle" />--}}
                </div>
            </div>
            <!--end col-->
            <div class="col">
                <div class="p-2">
                    <h3 class="text-white mb-1">{{$company->name}}</h3>
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i
                                    class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>{{$company->city_town}}</div>
                        <div><i class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{{$company->street_address}}
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link fs-14 active" data-bs-toggle="tab" href="#overview-tab" role="tab">
                                <i class="ri-airplay-fill d-inline-block d-md-none"></i> <span
                                        class="d-none d-md-inline-block">Summary</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-14" data-bs-toggle="tab" href="#projects" role="tab">
                                <i class="ri-price-tag-line d-inline-block d-md-none"></i> <span
                                        class="d-none d-md-inline-block">Tenders</span>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-pane active" id="overview-tab" role="tabpanel">
                        <div class="row">
                            <div class="col-xxl-3">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title mb-5">SUPPLIER NO: {{$company->supply_no}}</h5>
                                    </div>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-borderless mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-muted">{{\Illuminate\Support\Facades\Auth::user()->first_name}} {{\Illuminate\Support\Facades\Auth::user()->last_name}} </td>
                                                </tr>
                                                <tr>
                                                    <th class="ps-0" scope="row">Tel :</th>
                                                    <td class="text-muted">{{$company->phone_no}}</td>
                                                </tr>
                                                <tr>
