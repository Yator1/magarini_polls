        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    ...
                    <form class="needs-validation" novalidate method="PUT" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="signin-other-title text-center">
                            ...
                            <h5 class="fs-13 mb-4 title text-muted">update</h5>
                        ...
                        <div class="row g-3 needs-validation">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{$user->first_name ?? old('first_name') ?? ''  }}" id="first_first_name" placeholder="Enter First Name" required>
                                @error('first_name')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{$user->last_name ??  old('last_name') ?? '' }}" id="first_last_name" placeholder="Enter Last Name" required>
                                @error('last_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('id_no') is-invalid @enderror" name="id_no" value="{{ $user->id_no ??  old('id_no') ?? '' }}" id="id_no" placeholder="Enter Id Number" required>
                                @error('id_no')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('phone_no') is-invalid @enderror" name="phone_no" value="{{ $user->phone_no ??  old('phone_no') ?? '' }}" id="phone_no" placeholder="Enter Phone Number" required>
                                @error('phone_no')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email ??  old('email') ?? '' }}" id="email" placeholder="Enter email address" required>
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" id="password" placeholder="Enter Password" >
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
...
{{-- 
                            <div class="col-lg-4">
                                ...
                                <select class="js-example-basic-single form-control  @error('sub_county')  is-invalid @enderror" name="sub_county" name="sub_county" value="{{ old('sub_county') }}" id="sub_county" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <label for="input-avatar" class="form-label">
                                    <i data-feather="file"></i> Upload Picture <span class="text-danger"></span></label>
