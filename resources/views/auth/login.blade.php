            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo mb-5">
{{--                                <img src="{{ URL::asset('build/images/murangalogo.png')}}" alt="" height="150">--}}
                            </a>
                        </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">I DELIVER POLL SYSTEM !</h5>
